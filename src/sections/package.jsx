    ...
    monthly: [
        {
            id: 1,
            name: "Arch Armor Dr4",
            description: "For Homes and Offices",
            buttonText: "Buy Now",
            priceWithUnit: "$67",
            points: [
                {
                    ...
                    text: "Good Port Density",
                    isAvailable: true,
                },
                {
                    id: 2,
                    icon: <IoIosCheckmarkCircle />,
                    text: "High Load Bearing",
                    isAvailable: true,
                },
                {
                    id: 3,
        ...
        },
        {
            ...
            anotherOption: "request discount coupon",
            points: [
                {
                    id: 1,
                    icon: <IoIosCheckmarkCircle />,
                    text: "High Virtualization",
                    isAvailable: true,
                },
                {
                    id: 2,
                    icon: <IoIosCheckmarkCircle />,
                    text: "Upto 500 connection ports",
                    isAvailable: true,
                },
                {
                    id: 3,
        ...
        },
        {
            ...
            points: [
                ...
                },
                {
                    id: 3,
                    icon: <IoIosCheckmarkCircle />,
                    text: "Upto 1000 connection ports",
                    isAvailable: true,
                },
                {
                    id: 4,
