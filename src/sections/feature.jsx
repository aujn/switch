...
const data = [
    {
        id: 1,
        imgSrc: Performance,
        altText: "Full Link Aggregation",
        title: "Full Link Aggregation",
    ...
    },
    {
        id: 2,
        imgSrc: Partnership,
        altText: "Field-proven layer 3 functionality",
        title: "Field-proven layer 3 functionality",
    ...
    },
    {
        id: 4,
        imgSrc: Support,
        altText: "High Scalability and Modularity",
        title: "High Scalability and Modularity",
        text: "We believe it’s important for everyone to have access to software – especially when it comes to digital learning be navigated by keyboard and screen readers.",
    },
];
